...
stack_secrets() {
    case "$1" in
        ...
        api)       printf 'PLATFORM_DB_HOST PLATFORM_DB_USER PLATFORM_DB_PASSWORD AKM_INTERNAL_SERVICE_TOKEN AKM_SIGNING_PRIVATE_KEY ANTHROPIC_API_KEY CHAT_CALLBACK_TOKEN MINIO_TENANT_ACCESS_KEY MINIO_TENANT_SECRET_KEY MODEL_ROUTER_INTERNAL_SERVICE_TOKEN MODEL_ROUTER_SIGNING_PRIVATE_KEY PROVIDER_KEY_ENCRYPTION_KEY' ;;
