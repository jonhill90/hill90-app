 ...
 * silently selecting an identity. This page requires admin role, so
 * whoever sets E2E_USERNAME must confirm the account carries it.
...
test.skip(
  ...
  "E2E_USERNAME and E2E_PASSWORD must both be set explicitly — skipping secrets E2E tests"
);
