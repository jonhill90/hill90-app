...
const INFRA_PATHS = ['/docs', '/openapi.json', '/internal/delegation-token', '/internal/chat/callback', '/internal/model-router/refresh-token', '/internal/discord/message', '/internal/discord/poll/{messageId}', '/internal/discord/bindings', '/discord/bindings', '/discord/bindings/{id}', '/discord/user-links', '/discord/user-links/{id}', '/discord/status'];
